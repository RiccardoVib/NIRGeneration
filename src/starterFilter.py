...
BATCH_SIZEs = [1000, 1000, 1000, 1, 1000]



model_ts = ['lstm', 'tcn', 'ssm', 'iir']
MINI_BATCH_SIZEs = [48000, 48000, 48000, 48000]
BATCH_SIZEs = [1000, 1000, 1, 1000]
...
datasets = ['Filtersnores']
datasets = ['FilterNeutronnores']
#datasets = ['FilterKorgnores']
